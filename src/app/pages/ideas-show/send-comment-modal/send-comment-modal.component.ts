...
@Component({
  selector: 'app-send-comment-modal',
  templateUrl: './send-comment-modal.component.html',
  styleUrls: ['./send-comment-modal.component.less']
})
export class SendCommentModalComponent implements OnInit {
